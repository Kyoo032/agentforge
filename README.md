...
| OS | Installer |
|----|-----------|
| **Windows** | [Agentforge Setup 0.11.0.exe](https://github.com/Kyoo032/agentforge/releases/download/v0.11.0/Agentforge.Setup.0.11.0.exe) (unsigned) |
| **macOS** | `.dmg` not published yet. It must be built on a Mac; it will land on the [same Releases page](https://github.com/Kyoo032/agentforge/releases/tag/v0.11.0) when it exists. |
