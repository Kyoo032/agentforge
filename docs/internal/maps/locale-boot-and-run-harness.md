...
`feat/web-phase4-tenant-secrets-rcbu9c`. Keyless search binds its Wikipedia host to `localeForRun` at tool registration; that binding was checked 2026-09-26 at cec1f72.
