...
`createDatasetStore` (`packages/host/src/datasets.ts:195-311`) is a repository over the kernel `datasets` table (`packages/db/src/schema.ts:616-631`, mirrored for older DBs at `packages/db/src/ensure-schema.ts:361-378`). `create` (`:208-253`):
...
| `packages/db/src/schema.ts:616-631`, `packages/db/src/ensure-schema.ts:361-378` | The `datasets` table and its back-fill |
