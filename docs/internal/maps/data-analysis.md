...
`createDatasetStore` (`packages/host/src/datasets.ts:195-311`) is a repository over the kernel `datasets` table (`packages/db/src/schema.ts:832-847`, mirrored for older DBs at `packages/db/src/ensure-schema.ts:375-392`). `create` (`:208-253`):
...
| `packages/host/src/router.ts:301-306` | The six data routes |
...
| `packages/db/src/schema.ts:832-847`, `packages/db/src/ensure-schema.ts:375-392` | The `datasets` table and its back-fill |
