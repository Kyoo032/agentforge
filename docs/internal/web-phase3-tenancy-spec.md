...
| `auth_sessions` + migration `0014` | `packages/db/src/schema.ts:731-749`; `packages/db/drizzle/0014_auth_sessions.sql:12-27`; journal entry idx 14 | Done. Carries `tenant_id`, `org_id`, `user_id` already. |
