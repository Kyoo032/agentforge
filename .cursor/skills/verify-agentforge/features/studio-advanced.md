...
- `/studio/<uuid>` matches the same `/studio/*` rule as `/studio/new` (`apps/web/src/App.tsx:164`); there is no separate agent-id route. Assert `agent-prompt` **and** `save-soul` at count 0 — both were 0 on 2026-09-17.
