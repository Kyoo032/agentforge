...
| testid | Surface |
|---|---|
| `mode-chat`, `mode-documents`, `mode-research`, `mode-finance`, `mode-data`, `mode-market`, `mode-legal`, `mode-meeting`, `mode-images`, `mode-videos`, `mode-music`, `mode-presentations`, `mode-edit` | Left rail work modes (Default has all of these). `mode-edit` shipped in 0.14.22 |
